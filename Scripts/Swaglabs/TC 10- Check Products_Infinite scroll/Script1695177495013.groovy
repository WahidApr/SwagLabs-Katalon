...
Mobile.tap(findTestObject('Object Repository/Swaglabs/10- Singleside_View'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Swaglabs/10.1- Productpage_Assertion'), 0)
