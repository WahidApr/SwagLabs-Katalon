...
Mobile.tap(findTestObject('Object Repository/Swaglabs/1.5- Side Bar'), 0)

Mobile.tap(findTestObject('Object Repository/Swaglabs/1.6-Logout'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Swaglabs/1.7- Boxusername'), 0)
