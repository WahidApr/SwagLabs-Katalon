...
Mobile.tap(findTestObject('Object Repository/Swaglabs/13- Cart-View'), 0)

Mobile.tap(findTestObject('Object Repository/Swaglabs/15- Remove Products'), 0)

Mobile.tap(findTestObject('Object Repository/Swaglabs/15- Remove Products1'), 0)

Mobile.tap(findTestObject('Object Repository/Swaglabs/15- Remove Products2'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Swaglabs/15- Empty Cart_Assertion'), 0)
